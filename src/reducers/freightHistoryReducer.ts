...
const columnsSetting = typeof localStorage.getItem('freight_columnsSetting') === 'string' ? JSON.parse(localStorage.getItem('freight_columnsSetting') || '') : '';
...
export const freightHistoryInfoReducer = (state = initialState, action: AnyAction) => {
    switch (action.type) {
        ...
        case TOGGLE_VIEW_COLUMN_SETTING:
            ...
            localStorage.setItem('freight_columnsSetting', JSON.stringify(state.columnsSetting));
        ...
        case RESTORE_COLUMN_SETTING:
            ...
            localStorage.setItem('freight_columnsSetting', JSON.stringify(clonedFreightHistoryColumnSettings));
        ...
        case CHANGE_COLUMN_ORDER_FREIGHT_HISTORY:
            ...
            localStorage.setItem('freight_columnsSetting', JSON.stringify(arr));
            return {
                ...state,
                columnsSetting: [...arr]
            }
