...
interface BOLInfo {
    ...
    deliveryDetailsObj: DeliveryDetailsValues;
...
const initialState: BOLInfo = {
    ...
    deliveryDetailsObj: {
        deliveryDate: null,
        deliveryReadyTime: '08:00',
        deliveryCloseTime: '15:00',
    },
    ...
    additionalInfoObj: {
        ...
        carrierName: "",
        serviceType: "",
        providerId: 0, //TODO - To be changed
        providerQuoteId: "",
        tariffId: "",
        franchiseCost: "",
    },
...
export const bol_InfoReducer = (state = initialState, action: AnyAction) => {
    switch (action.type) {
        ...
        case INITIALIZE_SHIPMENT_DETAIL:
            return {
                ...state,
                shipmentDetailsWrapper: {
                    ...state.shipmentDetailsWrapper,
                    freightItems: action.payload,
                },
            };
        ...
        case UPDATE_UPSCAPITAL_INSURANCE_INFO:
            return {
                ...state,
                upsCapitalInsuranceObj: {
                    ...state.upsCapitalInsuranceObj,
                    [action.payload.updKey]: action.payload.updValue,
                },
            };    
        ...
        case INIT_ADDITIONAL_INFO:
            return {
                ...state,
                additionalInfoObj: initialState.additionalInfoObj
            }
        case UPDATE_HAZMAT:
            return {
                ...state,
