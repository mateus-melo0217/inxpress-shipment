...
import { PAGE_OPTIONS, PageOptionType } from "./QuotesController";

interface PropTypes {
    table: Table<QuoteTypes>
    totalCount: number;
    resetPaginator: Boolean;
    setResetPaginator: Function;
    selectedPerPage: PageOptionType;
    setSelectedPerPage: Function;
}

export const QuotesPaginator = ({ table, totalCount, resetPaginator, setResetPaginator, selectedPerPage, setSelectedPerPage }: PropTypes) => {
