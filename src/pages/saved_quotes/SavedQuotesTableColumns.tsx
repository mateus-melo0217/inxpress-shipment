...
export const tableColumns = (hIndex:number, setHIndex:Function, columnsSetting: any, setLoading:Function, refetch:Function) => {
                ...
                columnHelper.display(
                    {
                        id: 'actions',
                        header: () => 'Action',
                        cell: (props) => <ActionColumn hIndex={hIndex} setHIndex={setHIndex} row={props.row} setLoading={setLoading} refetch={refetch}/>
                    }
                )    
            ) : columnItems.push(
