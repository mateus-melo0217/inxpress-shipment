...
import {exportSavedQuotesSummaries} from "pages/bol_info/api/bol_api";
import { SortingState, Table } from "@tanstack/react-table";
import { PAGE_OPTIONS, PageOptionType } from "./SavedQuotesController";
...
type PropTypes = {
    ...
    perPage: PageOptionType;
    setPerPage: Function;
}

export const SavedQuotesTopOptions = ({isFilterOpen, toggleFilter, sorting, table, perPage, setPerPage}: PropTypes) => {
    const [pageMenuOpen, setPageMenuOpen] = useState(false);
    const [isSettingMenuOpen, setSettingMenuOpen] = useState(false);
    return (
        <>
            <div className="flex justify-between items-center w-full p-5">
                <p className="">Quotes are valid for 48 hours and are saved for 30 days.</p>
                <div className="block">
                    <div className="flex justify-end w-full relative">
                        <div className="flex items-center space-x-6">
                            <Button
                                ...
                                onClick={() => {
                                    exportSavedQuotesSummaries(sorting);
                                }}
                            />
